...
# 使用说明
echo "使用说明:"
echo "1. ./update.sh hot - 获取周排行榜前10个更新轮播"
echo "2. ./update.sh new - 获取最新更新的10个更新轮播"
echo "3. ./update.sh doubanId=35095038 - 更新指定豆瓣ID的轮播"
echo "4. ./update.sh doubanId=35095038*36013212 - 更新多个豆瓣ID的轮播"
